...
subroutine WriteSnapshot()
    ...
    do i = 1, Natoms
        ...
        !    i, KHIST(i), XD(1:3,i), Q1D(1:3,i)/dt, Ep(i)*ENUNIT, Ek(i)*ENUNIT, T, E_tot, DR(1:3,i), KTYPE(i) ! write x, y, z displacement of particle i as well
        write(file_id, "(I7,1X,I2,3(1X,E12.5),7(1X,E10.3),3(1X,E10.3),1X,I2)") &
            i, KHIST(i), XD(1:3,i), Q1D(1:3,i)/dt, Ep(i)*ENUNIT, Ek(i)*ENUNIT, T, E_tot, DR(1:3,i), KTYPE(i)
